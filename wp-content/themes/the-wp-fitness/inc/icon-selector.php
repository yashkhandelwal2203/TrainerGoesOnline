...
class The_WP_Fitness_Icon_Selector extends WP_Customize_Control{
      public $type = 'icon';
            ...
            <label>
                  ...
                  <ul class="icon-list">
                      <div class="social-icon-search">
                          <input class="socialInput" type="text" placeholder="<?php echo esc_attr('Search Icon', 'the-wp-fitness'); ?>">
                      </div>
                    <?php
                    $the_wp_fitness_font_awesome_icon_array = the_wp_fitness_font_awesome_icon_array();
                    foreach ($the_wp_fitness_font_awesome_icon_array as $the_wp_fitness_font_awesome_icon) {
                            $icon_class = $this->value() == $the_wp_fitness_font_awesome_icon ? 'icon-active' : '';
                            echo '<li class='.esc_attr($icon_class).'><i class="'.esc_attr($the_wp_fitness_font_awesome_icon).'"></i>
                            <span class="the-wp-fitness-social-class">'.esc_attr($the_wp_fitness_font_awesome_icon).'</span>
                            </li>';
                        }
                    ?>
                  </ul>
...
function the_wp_fitness_customizer_script() {
     
    wp_enqueue_style( 'font-awesome-1', esc_url(get_template_directory_uri()).'/css/fontawesome-all.css');
}
add_action( 'customize_controls_enqueue_scripts', 'the_wp_fitness_customizer_script' );

if(!function_exists('the_wp_fitness_font_awesome_icon_array')){
    function the_wp_fitness_font_awesome_icon_array(){
