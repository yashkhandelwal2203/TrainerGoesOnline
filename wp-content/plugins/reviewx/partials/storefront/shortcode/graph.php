                ...
                if ( isset( $data['template'] ) && $data['template'] == 'graph_style_default' ) { ?>
                    ...
                    <?php if( \ReviewX_Helper::is_multi_criteria( get_post_type( $data['prod_id'] ) ) ) { 
                            ...
                            foreach( $rating_info['rating_count'] as $rt ) {   
                                if( array_key_exists( 'total_review', $rt ) ) {
                                ...
                                <div class="progress">
                                    ...
                                    <?php  else: ?>
                                        <div class="progress-bar" style="width: 0%;">
                                            <span><?php echo __('0', 'reviewx');?>%</span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div> 
                    ...
                    <div class="progress-bar">
                        ...
                        <div class="progress-track">
                            <div class="rx_style_one_progress orange">
                                ...
                                <?php  else: ?>
                                    <div class="rx_style_one_progress-bar" style="width: 0%; height: 100%;">
                                        <span class="rx_style_one_progress-icon">
                                            <img src="<?php echo esc_url( plugins_url( '/', __FILE__ ) . '../../../resources/assets/storefront/images/rocket.svg' ); ?>" class="img-fluid">
                                        </span>
                                        <div class="rx_style_one_progress-value"><span><?php echo __( '0', 'reviewx' ); ?></span>%</div>
                                    </div>
                                <?php endif; ?>                                        
                            </div>
                        </div>
