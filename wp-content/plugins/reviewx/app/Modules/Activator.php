...
class Activator
{
     ...
     * @return void
     */
    public static function createImportHistoryTable()
    {
        global $wpdb;
        $table_name = $wpdb->prefix . 'reviewx_import_history';
        if ( ! self::tableExists($table_name) ) {
            $sql = "CREATE TABLE $table_name (
				batch_id int(11) NOT NULL PRIMARY KEY,
