                                ...
                                foreach ( $cri as $key => $single_criteria ) {
                                    ...
                                    <div class="progress-bar">
                                        ...
                                        <div class="progress-track">
                                            <?php
                                                $review_criteria_bar_color = "";
                                                if ( ! empty( $inc ) ) {
                                                    $review_criteria_bar_color = isset( $review_criteria_bar_color[$inc] ) ? $review_criteria_bar_color[$inc] : "";
                                                }
                                            ?>
                                            <div class="progress-fill"  style="<?php echo esc_attr( $review_criteria_bar_color ) ; ?>">
                                                <?php if( $percentage > 0 ) : ?>
