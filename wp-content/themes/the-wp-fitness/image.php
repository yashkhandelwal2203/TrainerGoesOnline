...
<div class="container">
    <main id="maincontent" role="main" class="main-wrap-box py-4">
        ...
        if($the_wp_fitness_left_right == 'Left Sidebar'){ ?>
            <div class="row">
                ...
                <div class="col-lg-8 col-md-8" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <?php edit_post_link( __( 'Edit', 'the-wp-fitness' ), '<footer role="contentinfo" class="entry-meta"><span class="edit-link">', '</span></footer>' ); ?>
                        </article>    
                        <?php
        ...
        <?php }else if($the_wp_fitness_left_right == 'Right Sidebar'){ ?>
            <div class="row">
                <div class="col-lg-8 col-md-8" id="wrapper">
                    <?php while ( have_posts() ) : the_post(); ?>    
                        <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
